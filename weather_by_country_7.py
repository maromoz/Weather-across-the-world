...
def city_temprature(country):
	...
	connection = pymysql.connect(host='localhost',
        ...
        with connection.cursor() as cursor:
                try:
			cursor.execute("select cities.name from cities inner join countries on cities.country_initials = countries.initials where countries.name = %s" , country)
	...
	connection = pymysql.connect(host='localhost',
        ...
        with connection.cursor() as cursor:
                try:
			cursor.execute("select temprature, pressure, humidity,  temprature_min, temprature_max from cities where name = %s" , city)
...
def country_average_temprature(country):
	...
	connection = pymysql.connect(host='localhost',
        ...
        with connection.cursor() as cursor:
                try:
			cursor.execute("select avg(temprature), avg(pressure),avg(humidity),avg(temprature_min),avg(temprature_min) from countries inner join cities on countries.initials = cities.country_initials where countries.name = %s" ,country)
